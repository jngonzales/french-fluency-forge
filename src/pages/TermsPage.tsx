    ...
    <div className="min-h-screen bg-bone">
      ...
      <main className="pt-20">
        ...
        <section className="py-16 md:py-20 relative overflow-hidden">
          <div className="absolute top-[10%] right-[15%] w-[350px] h-[250px] bg-magenta/15 rounded-full blur-[100px]" />
          <div className="absolute bottom-[10%] left-[10%] w-[300px] h-[200px] bg-uv/12 rounded-full blur-[80px]" />
