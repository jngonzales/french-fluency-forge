    ...
    <div className="min-h-screen bg-bone">
      ...
      <main className="pt-20">
        ...
        <section className="py-16 md:py-20 relative overflow-hidden">
          <div className="absolute top-[10%] left-[15%] w-[350px] h-[250px] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,hsl(335_100%_59%_/_0.15)_0%,transparent_70%)]" />
          <div className="absolute bottom-[10%] right-[10%] w-[300px] h-[200px] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,hsl(260_100%_58%_/_0.12)_0%,transparent_70%)]" />
