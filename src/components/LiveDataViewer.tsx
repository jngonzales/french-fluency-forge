...
export function LiveDataViewer({ sessionId, moduleType }: LiveDataViewerProps) {
  ...
  if (recordings.length === 0) {
    return (
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <div className="fixed bottom-24 right-4 z-[9996] w-80 bg-card/95 border border-border rounded-lg shadow-xl">
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <div className="fixed bottom-24 right-4 z-[9996] w-96 bg-card/95 border border-border rounded-lg shadow-xl overflow-hidden">
        <CollapsibleTrigger asChild>
