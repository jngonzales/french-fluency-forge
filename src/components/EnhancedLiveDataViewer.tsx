...
export function EnhancedLiveDataViewer({ sessionId, moduleType }: EnhancedLiveDataViewerProps) {
  ...
  if (!trace) {
    return (
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <div className="fixed bottom-4 left-4 z-[9996] w-96 bg-card/95 border border-border rounded-lg shadow-xl">
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <div className="fixed bottom-4 left-4 z-[9996] w-[600px] max-h-[700px] bg-card/95 border border-border rounded-lg shadow-xl overflow-hidden">
        <CollapsibleTrigger asChild>
